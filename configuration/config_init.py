...
def get_config():
    ...
    # '../pretrain/gmarevgrad_clspool_0.000001/pretrain_6_default.pth'
    ...
    parse.add_argument('-batch-size', type=int, default=16)#112

    parse.add_argument('-lr', type=float, default=0.000005)# general: 0.00005   4mC_Tolypocladium: 0.00001
