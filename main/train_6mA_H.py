...
def select_dataset():
    ...
    # path_train_data = '../data/DNA_MS/tsv/6mA/6mA_Ca.elegans/train.tsv'
    # path_test_data = '../data/DNA_MS/tsv/6mA/6mA_Ca.elegans/test.tsv'
    # path_train_data = '../data/DNA_MS/tsv/6mA/6mA_Cb.equisetifolia/train.tsv'
    # path_test_data = '../data/DNA_MS/tsv/6mA/6mA_Cb.equisetifolia/test.tsv'
