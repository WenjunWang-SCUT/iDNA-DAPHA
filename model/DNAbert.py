...
class BERT(nn.Module):
    def __init__(self, config):
        ...
        if self.kmer == 3:
            ...
            self.pretrainpath = '../pretrain/DNAbert_6mer'#'../pretrain/DNAbert_6mer'
    ...
    def forward(self, seqs):
        ...
        # print(kmers)
        # print(len(kmers))
        token_seq = self.tokenizer(kmers, return_tensors='pt') #, add_special_tokens=False
        # print(token_seq)
        ...
        if self.config.cuda:#last_hidden_state     pooler_output
